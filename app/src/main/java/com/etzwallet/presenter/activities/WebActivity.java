...
public class WebActivity extends BRActivity {
    private WebView web;
...
//			}
        ...
        web.addJavascriptInterface(new JsInterface(getApplicationContext()), "easyetz");
//        web.loadUrl("file:///android_asset/anomalies/index.html");
...
//    class JsInterface {
//        @JavascriptInterface
//        public void etzTransaction(final String address, final String value, final String data) {
//
//            WalletsMaster master = WalletsMaster.getInstance(WebActivity.this);
//            final BaseWalletManager wm = master.getCurrentWallet(WebActivity.this);
//            if (!wm.isAddressValid(address)) {
//                sayInvalidClipboardData(getResources().getString(R.string.Send_invalidAddressTitle));
//                return;
//            }
//            if (Utils.isNullOrEmpty(data)||!data.startsWith("0x")){
//                sayInvalidClipboardData(getResources().getString(R.string.Dapp_dataError));
//                return;
//            }
//
//            BRSharedPrefs.putCurrentWalletIso(WebActivity.this, "etz");
//            Intent intent = new Intent(WebActivity.this, DappTransaction.class);
...
//            Toast.makeText(getApplicationContext(), WalletEthManager.getInstance(getApplication()).getAddress(), Toast.LENGTH_LONG).show();
//            return WalletEthManager.getInstance(getApplication()).getAddress();
//        }
//
//        @JavascriptInterface
...
//                balance = String.valueOf(BRSharedPrefs.getCachedBalance(getApplication(), iso).divide(new BigDecimal(WalletEthManager.ETHER_WEI)));
//            } else {
//                balance = String.valueOf(BRSharedPrefs.getCachedBalance(getApplication(), iso));
//            }
//
...
//            BRDialog.showCustomDialog(WebActivity.this, "",title ,
